...
%--------------------------------------------------------------------------------------%
load([data_path,'/Logistic_model_params/LogitBeta.mat'])
...
[H,P, CI, STATS] = ttest(LogitBeta.Control_yee_self,0); 
[H,P, CI, STATS] = ttest(LogitBeta.Active_yee_self,0); 
...
p = vartestn(Logit_self,Condition,'TestType','LeveneAbsolute','display','on');
