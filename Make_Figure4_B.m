...
%------------------------------------------------------------------
%This data represents the PPI contrast on the "Feedback" epoch for 
%cTBS-vertex>cTBS-rTPJ extracted at p=0.001 
%in the whole-brain family-wise error corrected cluster in dmPFC
%Christopher Hill, June 2017


load([pwd, '/Processed_data/Neural_betas/PPI_dmPFC_betas'])
...
%-------------------------------------------
A = betas_PPI_dMPFC_cTBSvertex; 
B = betas_PPI_dMPFC_cTBSrTPJ; 
...
title('Effect of cTBS on rTPJ-dmPFC connectivity','FontSize',25)